...
GitHub is a website that **hosts Git repositorys** (i.e. your code). You upload your code to GitHub and allows you to colloborate with others. GitHub is private company - owned by Microsoft.
]
...
<br> <br> 
- Rstudio provides a UI so the previous terminal commands are not neccessary  
<br> <br> 
...
<br>
<h3>
- Always pull before committing your files <br>
...
- README is a text file that describes your repository/project. This is a great place to place a description of the project, documentation, and attributions <br>
- Cloning and forking 
</h3>
...
- By default, `git add -A` commits adds everything in the repo
...
- e.g. `Inputs/*.tsv` excludes all tsv files in the `Inputs` subfolder
]
