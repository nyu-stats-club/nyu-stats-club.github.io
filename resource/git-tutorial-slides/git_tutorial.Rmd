...
<h2>
- 99% of your Git tasks can likely be accomplished through Rstudio using [Rstudio Projects](https://support.rstudio.com/hc/en-us/articles/200526207-Using-Projects)  
<br> 
...
- Always `pull` before committing your files
...
- README is a text file that describes your repository/project. This is a great place to place a description of the project, documentation, and attributions
- Cloning and forking
